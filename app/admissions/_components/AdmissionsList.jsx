...
export default function AdmissionsList({ defaultTab = "general" }) {
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <div className="rounded-[32px] border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-white p-8 shadow-sm">
                <div className="flex flex-wrap items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-slate-500 font-medium">
                            Quản lý các đợt tuyển sinh, nhắm mục tiêu vào phần <span className="text-blue-600 font-bold">{defaultTab}</span>.
                        </p>
                    </div>
                    <div className="flex gap-3">
                        <Button
                            variant="flat"
                            className="rounded-2xl font-bold bg-white/50 backdrop-blur-sm border border-blue-100"
                            isLoading={isBusy}
                        ...
                        <Link href={`/admissions/new#${defaultTab}`}>
                            <Button
                                color="primary"
                                className="rounded-2xl font-bold px-8 shadow-lg shadow-blue-200 bg-blue-600 hover:bg-blue-700"
                ...
                {records.length > 0 ? (
                    records.map((record) => (
                        <div
                            ...
                            className="group relative rounded-[32px] border border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-blue-200 hover:shadow-xl hover:shadow-blue-50"
                        >
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex gap-4">
                                    <div className="flex h-16 w-16 items-center justify-center rounded-[24px] bg-slate-50 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-500 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1 flex items-center gap-2">
                                            <span className="font-bold text-blue-600 text-sm">{record.degree}</span>
                                ...
                                <div className="flex flex-col items-end gap-2">
                                    ...
                                    <Link href={`/admissions/${record._id ?? record.id}#${defaultTab}`}>
                                        <Button
                                            size="sm"
                                            variant="light"
                                            className="font-bold text-blue-600 rounded-xl"
                            ...
                            <div className="mt-8 grid grid-cols-3 gap-3">
                                <div className={`rounded-2xl p-4 border border-transparent transition-all ${defaultTab === 'general' ? 'bg-blue-50 border-blue-100' : 'bg-slate-50'}`}>
                                ...
                                <div className={`rounded-2xl p-4 border border-transparent transition-all ${['cutoff', 'admitted'].includes(defaultTab) ? 'bg-blue-50 border-blue-100' : 'bg-slate-50'}`}>
                                ...
                                <div className={`rounded-2xl p-4 border border-transparent transition-all ${defaultTab === 'additional' ? 'bg-blue-50 border-blue-100' : 'bg-slate-50'}`}>
                    ...
                    <div className="col-span-full rounded-[32px] border-2 border-dashed border-slate-100 bg-white p-12 text-center">
                        <div className="mx-auto h-20 w-20 rounded-full bg-blue-50 flex items-center justify-center text-blue-400 mb-4">
                        ...
                        <Link href="/admissions/new">
                            <Button
                                color="primary"
                                className="mt-6 rounded-2xl font-bold px-8 shadow-lg shadow-blue-200"
                            >
